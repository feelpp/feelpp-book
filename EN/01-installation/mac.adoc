...
Install Homebrew-science and Feel{plus}{plus} taps to get Feel{plus}{plus} and the link:prerequisites.adoc[scientific software] recommended or suggested for Feel{plus}{plus}.
----
$ brew tap homebrew/homebrew-science feelpp/homebrew-feelpp
----
