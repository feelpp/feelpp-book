...
In the context of blood flow modeling, an extension of power model was proposed by Walburn and Schneck. Parameters $$k$$ and $$n$$ are related to the haematocric $$Ht$$ :

$$
k = C_1 exp(C_2 Ht ), \quad\quad    n = 1- C_3 H t
$$
and $$C_1$$, $$C_2$$ and $$C_3$$ are 3 parameters.
