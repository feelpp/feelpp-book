...
Docker is a container technology providing:
 ...
 . an engine to start and stop container,
 . a user friendly interface from the creation to the distribution of containers and 
 . a hub  -- cloud service for container distribution -- thats provides publicly a huge number of containers to download and avoid duplicating work.
