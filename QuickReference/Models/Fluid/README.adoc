...
This will generate an executable named `feelpp_application_fluid_2d`. To execute it, you need to give the path of the cfg file associated to your case, with `--config-file`.

For example

----
./feelpp_application_fluid_2d --config-file={sourcedir}/applications/models/fluid/cavity/cavity3d.cfg
----
