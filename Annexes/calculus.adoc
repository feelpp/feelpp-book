...
Let latexmath:[\Omega] be a non-empty open of latexmath:[\mathbb{R}^n], de fronti\`ere not\'ee latexmath:[\partial\Omega]. On note $n$ la normale locale sur latexmath:[\partial\Omega].
