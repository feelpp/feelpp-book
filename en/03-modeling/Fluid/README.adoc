...
We choose here a $$\mathbb{P}_2$$ space for the velocity order and a $$\mathbb{P}_1$$ space for the pressure order.
This definition allows us to create our fluid model object FM like this
