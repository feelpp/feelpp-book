...
==== Points
In order to evaluate some fields at specif point and save the results in .csv file, user must define (i) "<tag>" representing this data in the .csv file, (ii) the coordinate of point and (iii) the fields evaluated.
